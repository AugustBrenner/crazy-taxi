...
function request(args, extra) {
	...
	var promise = new Promise(function(resolve, reject) {
		...
		requestHandler(params, function (error, response, body) {
			...
			resolve(cast(args.type, response.body))
		})
...
module.exports = {request: request, jsonp: jsonp, setCompletionCallback: setCompletionCallback}
